    ...
    <div className={styles.container}>
      <div className={styles.about}>
        <div
          data-aos="zoom-in"
          data-aos-delay="800"
          className={cn(styles.date, "sn-pro-regular")}>
          20.03.2026
        </div>
        <h2
        ...
        <p
          className={cn("sn-pro-regular", styles.paragraph)}
          data-aos="fade-up">
      ...
      <div className={styles.calendar}>
        <div
          className={cn(styles.mouth, "sn-pro-regular")}
          data-aos="fade-up">
          МАРТ 2026
        </div>
        <div
          className={styles.calendarImgContainer}
          data-aos="fade-up">
          <CalendarTemplate />
          <img
